...
public class create_And_Visited_Graph {
    ...
    public static void main(String[] args) {
        ...
        n2.neighbors.add(n1);n2.neighbors.add(n5);n2.neighbors.add(n4);

        n3.neighbors.add(n2);n3.neighbors.add(n4);

        n4.neighbors.add(n2);n4.neighbors.add(n5);n4.neighbors.add(n3);

        n5.neighbors.add(n4);n5.neighbors.add(n1);n5.neighbors.add(n2);
        //深度优先遍历
        DFS(n1);
//        System.out.println();
        //广度优先遍历
